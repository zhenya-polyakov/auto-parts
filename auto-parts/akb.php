...
<script type="text/javascript" src="js/jquery-1.7.1.min.js"></script>
        ...
        var show = 2; 		   
      $.post("../index.php?route=product/search", {vendor:vendor,car:car,mod:mod,table:table,show:show}, function(){
...
<div id="content">
 ...
 <form id="select_form" action="../index.php?route=product/search&filter_name=%20&filter_category_id=75&filter_sub_category=true&filter_description=true" method="post">
   <h3>Подбор аккумуляторов</h3>
        Производитель:<br />
        <select id="category1" name="vendor" style="width: 200px;">
            <?php echo $opt->ShowCategory(podbor_akb); ?>
        </select>
        <br /><br /> 
           Марка:<br />
            ...
            <input type="submit" class="button" id="button-search" value="Подтвердить" />
			<br><br>			   
