...
<script type="text/javascript" src="js/jquery-1.7.1.min.js"></script>
        ...
        $(document).ready(function(){
            ...
            $.post("select_year.php", {vendor:vendor,car:car,table:table}, function(data){
            ...
            $.post("show_modification.php", {vendor:vendor,car:car,year:year,table:table}, function(data){
        ...
        $.post("shini_show.php", {vendor:vendor,car:car,year:year,mod:mod,table:table,show:show},
             function(data){                
                $("#result").html(data);
                 }); 
                 return false;           
...
<div id="content">
 ...
 <form id="select_form" action="../index.php?route=product/search&filter_name=%20&filter_category_id=74&filter_sub_category=true&filter_description=true" method="post">
  <h3>Подбор шин и дисков</h3>
        ...
        <br /><br /> 
           Марка:<br />
            ...
            <br /><br />
            Год выпуска:<br />
            <select id="year1" name="year" style="width: 200px;">
                <option value="0">Выбрать...</option>
            </select>            
            <br /><br />
            Модификация:<br />
